...
class DoneRecipesShareButton extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      shouldDisplay: false,
  ...
  handleClick() {
    ...
    const clipboard = window.location.href.replace('/receitas-feitas', `/${type}s/${id}`);
...
DoneRecipesShareButton.propTypes = {
  index: PropTypes.number.isRequired,
  id: PropTypes.string.isRequired,
  type: PropTypes.string.isRequired,
};

export default DoneRecipesShareButton;
